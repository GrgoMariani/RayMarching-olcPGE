...
ECHO 			= echo -e
ASM_FLAGS 		= -fwin32
LINKER_FLAGS 	= -lpsapi -static-libgcc -static-libstdc++ -lws2_32 -lpthread
else
# Linux
ECHO 			= echo
ASM_FLAGS 		= -felf
LINKER_FLAGS 	= -pthread -lX11 -lglut -lGL -lGLU -lpthread -lpng -lstdc++fs
endif
...
CXX_FLAGS 	:= -std=c++14 -fPIC -Wall -O3 -Weffc++
